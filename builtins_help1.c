...
/**
 * help_all - display all builtin myshell commands
 *
 * Return: none
 */
...
/**
 * help_alias - display info on myshel command alias
 *
 * Return: none
 */
...
/**
 * help_cd - display info on myshell command cd
 *
 * Return: none
 */
...
/**
 * help_exit - display info on myshell comand exit
 *
 * Return: none
 */
void help_exit(void)
...
/**
 * help_help - Displays info myshell command 'help'.
 *
 * Return: none
 */
void help_help(void)
